...
// require('../../../utility/common.js').main(data,ref)
...
// require('../../common_definitions/promo.js').main(data,ref)
// require('../../common_definitions/precheckout.js').main(data,ref)
...
// require('../step-definitions/o5a_account.js').main(data,ref)